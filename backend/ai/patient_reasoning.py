...
def analyze_student_communication_rule_based(message: str) -> Dict[str, Any]:
    ...
    patient_relevant = any(k in msg_lower for k in relevance_patterns)

    return {
        "intent": res["intent"],
        "tone": res["tone"],
        "severity": res["severity"],
        "contains_insult": res["insult"],
        "contains_threat": res["threat"],
        "empathetic": res["empathetic"],
        "reassuring": res["reassurance"],
